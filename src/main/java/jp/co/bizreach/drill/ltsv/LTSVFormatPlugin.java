...
public class LTSVFormatPlugin extends EasyFormatPlugin<LTSVFormatPlugin.LTSVFormatConfig> {

    private static final boolean IS_COMPRESSIBLE = false;
    private static final String DEFAULT_NAME = "ltsv";
    private LTSVFormatConfig config;
    ...
    public LTSVFormatPlugin(String name, DrillbitContext context, Configuration fsConf, StoragePluginConfig storageConfig) {
        this(name, context, fsConf, storageConfig, new LTSVFormatConfig());
    }

    public LTSVFormatPlugin(String name, DrillbitContext context, Configuration fsConf, StoragePluginConfig config, LTSVFormatConfig formatPluginConfig) {
    ...
    @JsonTypeName("ltsv")
    public static class LTSVFormatConfig implements FormatPluginConfig {
